Attribute VB_Name = "WhitdrawFromStorageUnit"
Attribute VB_Description = "L_TO_CREATE_SINGLE - Withdraw from Storage Unit"

Sub WhitdrawFromStorageUnit()
    ...
    Dim columFromStorageUnit As String
    ...
    columnMaterial = "A"
    columnQuantity = "B"
    columFromStorageUnit = "C"
    columToStorageType = "D"
    columToStorageBin = "E"
    columDate = "F"
    columReason = "G"
    columResult = "H"
    ...
    formatedStorageLocation = Format(ThisWorkbook.ActiveSheet.Range(cellStorageLocation).Value, "0000")   
        ...
        On Error Goto Cleanup
            ...
            For i = firstRow To lastRow
                ...
                cellStorageUnit = Format(ThisWorkbook.ActiveSheet.Range(columFromStorageUnit & i).Value, "00000000000000000000")
                ...
                ExportParams("I_VLENR").Value = cellStorageUnit
